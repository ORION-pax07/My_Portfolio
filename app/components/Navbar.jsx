    ...
    return (
        <>
            ...
            <nav className={`w-full fixed top-0 left-0 px-5 lg:px-8 xl:px-[8%] py-4 flex 
                ...
                <ul ref={sideMenuRef} className='flex md:hidden flex-col gap-20 py-20 px-10 fixed -right-64 
                    top-0 bottom-0 w-64 z-50 h-screen bg-rose-300 transition duration-500'>
